...
import static com.example.mydemo.PrintBean.PRINT_TYPE;
        ...
        switch (requestCode){
            case PERMISSION_REQUEST_COARSE_LOCATION:
                if (grantResults[0]==PackageManager.PERMISSION_GRANTED){
                    Toast.makeText(PrintActivity.this,"已授权",Toast.LENGTH_SHORT).show();
                }else {
                    Toast.makeText(PrintActivity.this,"已拒绝授权",Toast.LENGTH_SHORT).show();
                }
                break;
        }
